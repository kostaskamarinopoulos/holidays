<html><body>
    ...
    <p>Dear supervisor, employee '.<?=$name?>!.' requested for some time off, starting on
        ...
        <a  class=”link” href="/https://www.controllerRouteUpdatingTheDBwithTheStatus/accept" target="_blank">
            Accept             
        </a>
        <a  class=”link” href="https://www.controllerRouteUpdatingTheDBwithTheStatus/reject" target="_blank">
            Reject             
        </a>'</p>
  </body></html>